...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>Star Ducks Cappucino Token Sale </h1>
        ...
        <h2>TO buy tokens send wei to this address {MyTokenSale.networks[this.networkId].address} </h2>
        <p>You current have : {this.state.userTokens}</p>
